    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.helperRow}>
          <Pressable
            onPress={() => Alert.alert('Forgot Password', 'Use the website to reset your password.')}
            disabled={busy}
          >
...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1, backgroundColor: '#fff', paddingHorizontal: 20, paddingTop: 40,
  },
  title: {
    fontSize: 24, fontWeight: '800', textAlign: 'center', marginBottom: 24,
  },
  stack: {
    gap: FIELD_GAP, // 👈 ensures Email↔Password spacing
  },
  input: {
    width: '85%',
    alignSelf: 'center',
  ...
  primaryBtn: {
    ...
    paddingVertical: 14,
    borderRadius: 10,
    marginTop: SECTION_GAP, // 👈 same rhythm before the button
  },
  primaryBtnText: {
