  ...
  return (
    <AuthProvider>
      ...
      >
        ...
        <Stack.Screen name="(auth)/membership-levels" options={{ headerShown: true, headerTitle: 'Choose a Plan' }} />
        <Stack.Screen name="replies/[id]" options={{ headerShown: true, headerTitle: 'Replies' }} />
      </Stack>
      {/* or simply: <Slot /> if you prefer the default router stacks */}
    </AuthProvider>
  );
}
